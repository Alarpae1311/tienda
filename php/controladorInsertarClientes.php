<html>
  <head>
    <title>Proceso de inserción de nuevo cliente</title>
  </head>
  <body>
...
echo "El código del cliente es: $codigo<br>";
//hemos recogido datos del formulario...
$clienteNuevo = new Cliente($codigo,$nombre,$apellidos,$direccion,$fechaNacimiento);
echo $clienteNuevo->getCodigo()."<br>";
