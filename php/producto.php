...
class Producto {
  ...
  //sql para actualización del producto
  function getUpdateSQL() {
    $sql = "UPDATE productos SET codigo=$this->codigo, descripcion=$this->descripcion, rebaja=$this->porcentajeRebaja, estarebajas=$this->estaRebajado, precio=$this->precio WHERE codigo=$this->codigoAntiguo";
